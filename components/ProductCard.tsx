...
export const ProductCard: React.FC<ProductCardProps> = ({ image, prompt, isGenerating, onRemove, isVeo3 = false }) => {
    ...
    const handleCopyPart = async (index: number, part: ScriptPart, e: React.MouseEvent) => {
        e.stopPropagation();
        // The IMPORTANT disclaimer is part of the full prompt generated by Veo3 model,
        // so it will be included when copying the full prompt.
        // For individual parts, we only copy the scene and speech.
            ...
            <div className="p-4">
                ...
                {prompt && isVeo3 && parsedScript && (
                    <div className="mt-4 space-y-3">
                        ...
                        {/* The IMPORTANT warning is now displayed once at the end of the Veo3 script */}
